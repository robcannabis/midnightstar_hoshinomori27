...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1126910534294450300/1221835310888128522/anw3d.gif?ex=661405ce&is=660190ce&hm=7d39c5f016741254af64acb41a397e3a43bdc46154672a5f94f6ec7d99e476ff&']; //รูปใหญ่
    ...
    const yyyt = ['YouTubemusic']; // ชื่อ button1
    const ddds = ['https://music.youtube.com/watch?v=IwQGnXpskoY']; // ลิ้ง button1

   const iooi = ['TikTok']; // ชื่อ button 2
   const iiio = ['https://www.tiktok.com/@kosaki_24']; // ลิ้ง button 2
